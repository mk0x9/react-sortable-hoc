...
/***/ (function(module, exports, __webpack_require__) {
	...
	function sortableContainer(WrappedComponent) {
	  ...
	  return _temp = _class = function (_Component) {
	    ...
	    function _class(props) {
	      ...
	      _this.handleSortEnd = function (e) {
	        ...
	        for (var i = 0, len = nodes.length; i < len; i++) {
	          ...
	          _this.constructor.removeElementAnimatedStyle(el);
	        }
	      ...
	      _this.setAnimatedProps = function (animatedProps) {
	        var onAnimateNodes = _this.props.onAnimateNodes;
	        ...
	        (0, _keys2.default)(animatedProps).forEach(function (index) {
	          var node = nodes[Number(index)].node;

	          var nodeProps = animatedProps[index];

	          (0, _keys2.default)(nodeProps).forEach(function (prop) {
	    ...
	    (0, _createClass3.default)(_class, [{
	      ...
	      value: function animateNodes() {
	        ...
	        for (var i = 0, len = nodes.length; i < len; i++) {
	          ...
	          if (transitionDuration) {
	            ...
	            animatedProps[i][_utils.vendorPrefix + 'TransitionDuration'] = transitionDuration + 'ms';
	          }
	          ...
	          animatedProps[i][_utils.vendorPrefix + 'Transform'] = 'translate3d(' + translate.x + 'px,' + translate.y + 'px,0)';
	        }
	        ...
	        if (this.index < this.newIndex) {
	          ...
	          for (var _i = this.index + 1; _i <= this.newIndex; _i++) {
	            ...
	            if (_i + 1 !== nodes.length) {
	              ...
	              indexTranslate.x += nodes[_i + 1].edgeOffset.left - nodes[_i].edgeOffset.left;
	            } else {
	              if (this.axis.y) {
	                indexTranslate.y += nodes[_i].node.offsetHeight; // possibly bad
	              }
	              if (this.axis.x) {
	                indexTranslate.x += nodes[_i].node.offsetWidth; // possibly bad
	              }
	            }
	          }
	      ...
	      value: function render() {
	        ...
	        return _react2.default.createElement(WrappedComponent, (0, _extends3.default)({
	          ref: ref
	        }, (0, _utils.omit)(this.props, 'contentWindow', 'useWindowAsScrollContainer', 'distance', 'helperClass', 'hideSortableGhost', 'transitionDuration', 'useDragHandle', 'pressDelay', 'pressThreshold', 'shouldCancelStart', 'onSortStart', 'onSortMove', 'onSortEnd', 'onAnimateNodes', 'axis', 'lockAxis', 'lockOffset', 'lockToContainerEdges', 'getContainer', 'getHelperDimensions')));
	      }
	    }], [{
	      key: 'removeElementAnimatedStyle',
	      value: function removeElementAnimatedStyle(el) {
	    ...
	    onAnimateNodes: _propTypes2.default.func,
