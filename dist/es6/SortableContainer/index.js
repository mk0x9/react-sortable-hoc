  ...
  return _temp = _class = function (_Component) {
    ...
    function _class(props) {
      ...
      _this.setAnimatedProps = function (animatedProps) {
        ...
        _Object$keys(animatedProps).forEach(function (index) {
          var node = nodes[Number(index)].node;

          var nodeProps = animatedProps[index];

          _Object$keys(nodeProps).forEach(function (prop) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return React.createElement(WrappedComponent, _extends({
          ref: ref
        }, omit(this.props, 'contentWindow', 'useWindowAsScrollContainer', 'distance', 'helperClass', 'hideSortableGhost', 'transitionDuration', 'useDragHandle', 'pressDelay', 'pressThreshold', 'shouldCancelStart', 'onSortStart', 'onSortMove', 'onSortEnd', 'onAnimateNodes', 'axis', 'lockAxis', 'lockOffset', 'lockToContainerEdges', 'getContainer', 'getHelperDimensions')));
      }
    }], [{
